        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                <h4 class="card-dname">排班安排</h4>
                                 <form class="form-inline m-t-30" action="${ctx }/schedulManager/page" method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>${t.cts}</td> 
                                             <td>
			                                  	...
			                                  	<a href="${ctx }/schedulManager/toedit?id=${t.id}&pageNo=${pageInfo.pageNum}" class="btn-link btn-sm">编辑</a>
			                                  	<a href="javascript:;" data-href="${ctx }/schedulManager/del?id=${t.id}&pageNo=${pageInfo.pageNum}" class="btn-link btn-sm del">删除</a>
			                                 </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                 ...
                                 <p style="color:red;">${msg }</p>
                                <form method="post" action="${ctx }/schedulManager/page">
